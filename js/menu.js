...
const numElements = document.querySelectorAll('.text-num');

numElements.forEach((el) => {
  const targetNumber = el.getAttribute('data-count'); // الحصول على الرقم المستهدف

  const counter = new countUp.CountUp(el, targetNumber, {
    suffix: '+', // إضافة علامة "+"
